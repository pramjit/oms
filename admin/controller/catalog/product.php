...
private static function compare_tax_rates ($a, $b) {
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$abc = $this->model_catalog_product->editProduct($this->request->get['product_id'], $this->request->post);
                        $this->session->data['success'] = $this->language->get('text_success');
...
'price_tax'  => number_format(round($this->model_catalog_product->calculate($result['price'], $result['tax_class_id'], $this->config->get('config_tax')), 2), 2),
		...
		$data['column_price'] = $this->language->get('column_price');
                $data['column_rtlr_price'] = $this->language->get('column_rtlr_price');
...
$data['config_tax_included'] = $this->config->get('config_tax_included');
		...
		$data['sort_price'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . '&sort=p.price' . $url, 'SSL');
                $data['sort_rtlr_price'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . '&sort=p.rtlr_price' . $url, 'SSL');
...
$data['entry_price_tax'] = $this->language->get('entry_price_tax'); //EDIT
		$data['entry_price'] = $this->language->get('entry_price');
                $data['entry_rtlr_price'] = $this->language->get('entry_rtlr_price');
$data['config_tax_included'] = $this->config->get('config_tax_included');
		...
		$data['tab_openbay'] = $this->language->get('tab_openbay');
                ...
                $data['tab_state']= $this->language->get('tab_state');
		...
		if (isset($this->request->post['location'])) {
			...
			$data['location'] = '';
                ...
                //######################################PRODUCT TO STATE###############################//
                $data['states'] = $this->model_catalog_product->getState($this->request->get['product_id']);
		...
		if (isset($this->request->post['price'])) {
			...
			$data['price'] = '';
                ...
                //Retailer Price Added In form
                if (isset($this->request->post['rtlr_price'])) {
			$data['rtlr_price'] = $this->request->post['rtlr_price'];
		} elseif (!empty($product_info)) {
			$data['rtlr_price'] = $product_info['rtlr_price'];
		} else {
			$data['rtlr_price'] = '';
		}
...
'price_tax'               => round($this->model_catalog_product->calculate($product_option_value['price'], $data['tax_class_id'], $this->config->get('config_tax'), false), 2),
