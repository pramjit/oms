...
/*Manage Order*/
 ...
 if ($this->user->hasPermission('access', 'manageorder/orderlist')) {
 $manageorder[] = array(
 'name' => ' Indent Order List',
 'href' => $this->url->link('manageorder/orderlist', 'token=' . $this->session->data['token'], true),
 'children' => array() 
 ); 
 }
...
/*budget Start*/
 ...
 if ($this->user->hasPermission('access', 'budget/budgetlist')) {
 $addbudget[] = array(
 'name' => 'Add Budget',
 'href' => $this->url->link('budget/budgetlist', 'token=' . $this->session->data['token'], true),
 'children' => array() 
 ); 
 }
...
/*MO Report Start*/
 ...
 'children' => array() 
  ...
  if ($this->user->hasPermission('access', 'report/staff_ta_submission')) {
 $kaireport[] = array(
 'name' => 'Staff Ta Submission',
 'href' => $this->url->link('report/staff_ta_submission', 'token=' . $this->session->data['token'], true),
 'children' => array() 
 ); 
 }
 ...
 'children' => array() 
  ...
  if ($this->user->hasPermission('access', 'report/paymentreport')) {
 $kaireport[] = array(
 'name' => 'Payment Report',
 'href' => $this->url->link('report/paymentreport', 'token=' . $this->session->data['token'], true),
 'children' => array() 
 ); 
 }
