...
class ControllerManageorderorderlist extends Controller{
	...
	/*-----------------------------insert receive order function ends here-----------------*/
        ...
        { 
            ...
            $prolist= $this->model_manageorder_orderlist->getProductList($this->request->post['indid']);
            //print_r($prolist);
            ...
            //echo "<select id='selectbasic' name='selectbasic' class='form-control'>";
            //echo "<option value=''>Option one</option>";
            //echo "</select>";
            echo "<input type='text' name='trans_name' value='".$pro['PRO_NAME']."' id='trans_name' class='form-control' required='required'>";
            echo "</div>";
            echo "<div class='col-md-3'>";
            echo "<input type='text' name='trans_name' value='' id='trans_name' class='form-control' required='required'>";
            echo "</div>";
            echo "<div class='col-md-3'>";
            echo "<input type='text' name='trans_name' value='' id='trans_name' class='form-control' required='required'>";
            echo "</div>";
            echo "<div class='col-md-1'>";
            echo "<button type='button' class='btn btn-default form-control'><i class='fa fa-plus-circle fa-2 btn-default' style='color:green;' aria-hidden='true'></i></button>";
            //echo "<div style='font-size: 24px;'><i class='fa fa-plus-circle fa-2 btn-default' style='color:green;' aria-hidden='true'></i>&nbsp;&nbsp;&nbsp;&nbsp;<i class='fa fa-minus fa-2 btn-default' aria-hidden='true' style='color:red;'></i></div>";
            echo "</div>";
            echo "<div class='col-md-1'>";
            echo "<button type='button' class='btn btn-default form-control'><i class='fa fa-minus fa-2 btn-default' aria-hidden='true' style='color:red;'></i></button>";
            //echo "<div style='font-size: 24px;'><i class='fa fa-plus-circle fa-2 btn-default' style='color:green;' aria-hidden='true'></i>&nbsp;&nbsp;&nbsp;&nbsp;<i class='fa fa-minus fa-2 btn-default' aria-hidden='true' style='color:red;'></i></div>";
            echo "</div>";
            echo "</div>";
