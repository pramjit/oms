...
public function download_excel() {
 ...
 if (isset($this->request->get['ws_id'])) {
	...
	$this->load->model('report/paymentreport');
	$data = $this->model_report_paymentreport->updateStatus($this->request->post);
        if($data){
        $this->load->model('user/user');
        $user_info = $this->model_user_user->getUser($this->user->getId());
        ...
        $SubDate=date('dM, Y');
        $OrderSts=$this->request->post['status_name'];
        $StoId=$MsgDtls['STO_ID'];
            ...
            $textmsg=str_replace('OrderSts',$OrderSts,$textmsg);
