...
class ControllerReportPossummaryreport extends Controller {
	public function index() {
		...
		$this->load->model('setting/store');
                ...
                $data["listMOs"] = $this->model_report_possummaryreport->getMo($usergroupid,$userid);
		...
		if($userid=='56' || $userid=='285')
                {
		$results = $this->model_report_possummaryreport->getadmindtl($filter_data);
                }
                elseif($usergroupid=="3"){
                    $results = $this->model_report_possummaryreport->getdailyam($filter_data);
                }
                else{
