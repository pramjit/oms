<?php
class ControllerReportProductStorewisesales extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('report/product_storewisesales', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$product_total = $this->model_report_product_storewisesales->getTotalsales($filter_data);
		...
		$pagination->url = $this->url->link('report/product_storewisesales', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
