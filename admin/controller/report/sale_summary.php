...
if (isset($this->request->get['filter_date_start'])) {
    ...
    foreach($results as $data)
    {
        ...
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3, $row, $data['currentcredit']); 
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(2, $row, $data['creditlimit']); 
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4, $row, $data['cash_order']); 
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5, $row, $data['tagged_order']); 
	...
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(7, $row, $data['Tagged']); 
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(8, $row, ($data['Cash']+$data['Tagged']));
