...
class ControllerSupplychainsupplychainorder extends Controller{
	...
	//$data['mo'] = $this->model_supplychain_supplychainorder->getmoname();
        $data['sap'] = $this->model_supplychain_supplychainorder->getsap();
        $data['wsp'] = $this->model_supplychain_supplychainorder->getwspname();
        //$data['product'] = $this->model_supplychain_supplychainorder->getproductname();
	//$data['order_list'] = $this->model_supplychain_supplychainorder->getList($start,$limit);
	/*
        if (!empty($this->request->get['sto_id']) || !empty($this->request->get['sap_id']) || !empty($this->request->get['pro_id'])) {
        ...
        $total_orders = $this->model_supplychain_supplychainorder->getTotalOrders();
	...
	/*-----------------------------insert receive order function ends here-----------------*/
        ...
        { 
            ...
            $this->load->model('supplychain/supplychainorder');
            $qrr= $this->model_supplychain_supplychainorder->sorderdispatch();
            //echo $qrr;
            if($qrr=='1'){
