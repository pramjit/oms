<?php
class Modelleadorderleads extends Model {
...
public function getOrderdtl($order_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "order_leads o WHERE o.order_id = '" . (int)$order_id . "'");
		return $query->rows;
	}
