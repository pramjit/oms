...
class ModelReportReconciliation extends Model {
	...
	public function getOrders($data = array()) {
		$sql = "SELECT o.store_name,o.store_id,o.order_id,DATE(o.date_added) as date,o.total,o.tagged,os.company   from oc_order o LEFT JOIN oc_store os on os.store_id=o.store_id where (`payment_method`='Tagged'  or `payment_method`='Tagged Cash' ) ";
...
$sql = "select count(*) as total from (SELECT o.store_name,o.order_id,DATE(o.date_added) as date,o.total,o.tagged from oc_order o where (`payment_method`='Tagged'  or `payment_method`='Tagged Cash' )  ";
