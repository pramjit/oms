        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
           ...
           <!-- <li><a href="#tab-attribute" data-toggle="tab"><?php echo $tab_attribute; ?></a></li>
            ...
            <li><a href="#tab-state" data-toggle="tab"><?php echo $tab_state; ?></a></li>
          </ul>
...
<?php if ($config_tax_included) { ?>
            ...
            <!-- Retaile Price Field Start-->
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-rtlr-price"><?php echo $entry_rtlr_price; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="rtlr_price" value="<?php echo $rtlr_price; ?>" placeholder="<?php echo $entry_rtlr_price; ?>" id="input-rtlr-price" class="form-control" />
                </div>
              </div>
            <!-- Retaile Price Field End-->
              <div class="form-group">
                          ...
                          <tbody>
                            ...
                            <tr id="option-value-row<?php echo $option_value_row; ?>">
                              ...
                              <td class="text-right"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][price_prefix]" class="form-control">
                                ...
                                <?php if ($config_tax_included) { ?>
                    <input type="text" placeholder="<?php echo $entry_price_tax; ?>" class="product_option_price_tax form-control" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][price_tax]" value="<?php echo $product_option_value['price_tax']; ?>" size="5" />
                    <?php } ?>
                    <input type="text" class="form-control product_option_price" placeholder="<?php echo $entry_price; ?>" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][price]" value="<?php echo $product_option_value['price']; ?>" size="5" /></td>                              <td class="text-right"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][points_prefix]" class="form-control">
...
<?php if ($config_tax_included) { ?>
                ...
                <?php } ?>
                <td class="text-right"><input type="text" name="product_special[<?php echo $special_row; ?>][price]" value="<?php echo $product_special['price']; ?>" placeholder="<?php echo $entry_price; ?>" class="product_special_price form-control" /></td>
                      <td class="text-left" style="width: 20%;"><div class="input-group date">
            ...
            <!--tab-quantity to display-->
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-left"><?php echo $entry_state; ?></td>
                      <td class="text-left"><?php echo $entry_price; ?></td>
                      <td class="text-left"><?php echo $entry_rtlr_price; ?></td>
                    </tr>
                  </thead>
                  <tbody>
                        <?php
                    ...
                    <tr>
                      <td class="text-left"><?php echo $state['ST_NAME']; ?></td>
                      <td class="text-left">
                         <input type="hidden" name="SL[]" value="<?php echo $state['ST_ID']; ?>">
                         <input type="text" name="<?php echo 'WS_ST_'.$state['ST_ID'].'_PD_'.$state['PROD_ID']; ?>" value="<?php echo $state['WS_PRICE'] ?>" placeholder="<?php echo $entry_price; ?>" id="input-quantitystore<?php echo isset($store_quantity['store_id'])?$store_quantity['store_id']:0 ; ?>" class="form-control" />                              
                        
                      </td>
                      <td class="text-left">
                         <input type="text" name="<?php echo 'RT_ST_'.$state['ST_ID'].'_PD_'.$state['PROD_ID']; ?>" value="<?php echo $state['RT_PRICE'] ?>" placeholder="<?php echo $entry_rtlr_price; ?>" id="input-quantitystore<?php echo isset($store_quantity['store_id'])?$store_quantity['store_id']:0 ; ?>" class="form-control" />                              
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-left">
                           ...
                           <?php if($store['store_id']==$store_quantity['store_id']){ $chk=true;  ?>
                         <input type="text" name="quantitystore<?php echo isset($store_quantity['store_id'])?$store_quantity['store_id']:0 ; ?>" value="<?php echo isset($store_quantity['quantity'])?$store_quantity['quantity']:0 ; ?>" placeholder="<?php echo $entry_quantity; ?>" id="input-quantitystore<?php echo isset($store_quantity['store_id'])?$store_quantity['store_id']:0 ; ?>" class="form-control" />                              
                          <?php  }  ?>
                    
                          <?php      } if(!$chk) { ?>
                         <input type="text" name="quantitystore<?php echo $store['store_id'] ; ?>" value="0" placeholder="<?php echo $entry_quantity; ?>" id="input-quantitystore<?php echo $store['store_id'] ; ?>" class="form-control" />                               
                          <?php  }  ?>
                      </td>
                      <td class="text-left">
                           <?php $chkpr=false; foreach ($product_store_quantity as $store_quantity) {   ?>                     
                           <?php if($store['store_id']==$store_quantity['store_id']){ $chkpr=true;  ?>
<div class="col-sm-2">
                           <input type="text"   onkeyup="updatePriceStore(this.value,this.id)" onpaste="updatePriceStore(this.value,this.id)" onchange="updatePriceStore(this.value,this.id)" name="qquantitystoreprice<?php echo isset($store_quantity['store_id'])?$store_quantity['store_id']:0 ; ?>" value="<?php echo isset($store_quantity['store_price'])?$store_quantity['store_price']:0 ; ?>" placeholder="<?php echo $entry_price; ?>" id="iinput-quantitystoreprice<?php echo isset($store_quantity['store_id'])?$store_quantity['store_id']:0 ; ?>" class="form-control" />                              
                           </div>
                           <div class="col-sm-4">
...
<div class="col-sm-2">
 ...
 function updatePriceStore(val,id){
       ...
       try{ 
					...
					if (value == 0) $('#'+id.slice(1)).val(0);
					else $('#'+id.slice(1)).val(calculateUntaxedValue(value, true));
                                    }catch(e){alert(e);}
				}
