...
<script src="view/javascript/sweetalertmaster/sweetalert.min.js" type="text/javascript"></script>
<link href="view/javascript/sweetalertmaster/sweetalert.css" type="text/css" rel="stylesheet"/>
<script src="view/javascript/select2/js/select2.js" type="text/javascript"></script>
<link href="view/javascript/select2/css/select2.css" type="text/css" rel="stylesheet"/>
...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <?php } ?>
    <a href="<?php echo $home; ?>" class="navbar-brand"><img src="view/image/logo.png" alt="Khandelwal"/></a></div>
  <?php if ($logged) { ?>
