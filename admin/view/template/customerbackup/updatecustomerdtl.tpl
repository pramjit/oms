 ...
 <?php echo $header; ?><?php echo $column_left; //print_r($lastdist); ?>
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="index.php?route=customer/updatecustomerdtl/custupdatedtl&token=<?php echo $token; ?>" method="post" id="filter_form" class="form-horizontal">
           ...
           <div class="col-sm-4"> 
            ...
            <div class="form-group ">
              ...
              <input class="form-control" type="text" id="First_Name" onchange="clear_First_Name()" onkeypress="return CheckIsCharacter(event,this);" name="first_name"  value="<?php echo $re['firstname']; ?>" placeholder="Enter first name"/>
           ...
           <div class="form-group ">
              ...
              <div class="col-sm-8">
              <input type="text" id="Last_Name" onchange="clear_Last_Name()" onkeypress="return CheckIsCharacter(event,this);" name="last_name" class="form-control" value="<?php echo $re['lastname']; ?>"  placeholder="Enter last name "/>
            ...
            <div class="form-group ">
              ...
              <div class="col-sm-8">
              <input type="text" id="Email_ID" onchange="clear_Email_ID()" maxlength="10" onkeypress="return IsNumeric(event);" name="email" class="form-control" value="<?php echo $re['User_id']; ?>"  placeholder="Enter user id " readonly="readonly"/>
             ...
             <div class="form-group ">
              ...
              <div class="col-sm-8">
              <input type="text" id="sapid"  name="sapid" class="form-control" placeholder="Enter Sap id " value="<?php echo $re['sap_id']; ?>" />
              </div>
            </div>
              ...
              <div class="col-sm-8">
               <select name="select_role" id="select_role" class="form-control select2" onchange="getareamanag(this.value);" >
                  ...
                  <?php foreach ($listROLEs as $listROLE) { ?>
                    <option value="<?php echo $listROLE['customer_group_id']; ?>"<?php if($listROLE['customer_group_id']==$re['customer_group_id']) { echo 'selected'; } ?>><?php echo $listROLE['name']; ?></option>
            ...
            <div class="form-group">
                ...
                <select name="stat_id" id="stat_id" class="form-control select2" onchange="district_state(this.value)"  >
                  ...
                  <?php foreach ($listSTATs as $listSTAT) { ?>
                    <option value="<?php echo $listSTAT['SID']; ?>"<?php if($listSTAT['SID']==$re['state_id']) { echo 'selected'; } ?>><?php echo $listSTAT['NAME']; ?></option>
            ...
            <div class="form-group">
                ...
                <select style="width:20%" name="dist_id[]" id="dist_id" class="form-control select2-selection select2-selection--multiple"  multiple="multiple" value="<?php echo $re[0]['firstname']; ?>" >
                    <option value=''>Select District</option>  
                    <?php foreach($dist as $distval) { ?>
                     <option value='<?php echo $distval["SID"]; ?>' <?php foreach($lastdist as $vid) { if($distval["SID"]==$vid["GEO_ID"]) { echo "selected"; } } ?>><?php echo $distval["NAME"]; ?></option> 
                     <?php }
                     ?>
                </select>
             ...
             <div class="form-group">
              ...
              <div class="col-sm-8">
              <input type="text" id="Address" onchange="clear_Address()" name="address" class="form-control" placeholder="Enter address " value="<?php echo $re['address']; ?>" />
...
function CheckIsCharacter(e,t){
 ...
 function district_state(stid)
 {
     //alert(stid);
        $.ajax({ 
        type: 'post',
        url: 'index.php?route=customer/updatecustomerdtl/getdistrict&token='+getURLVar('token'),
        data: 'state_id='+stid,
        // dataType: 'json',
        cache: false,
