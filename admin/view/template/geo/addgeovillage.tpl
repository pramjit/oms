  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <button type="submit" form="form-restore" data-toggle="tooltip" title="Add Village" class="btn btn-default"><i class="fa fa-reply"></i></button>
      </div>
      <h1>Add Geo Village</h1>
      <ul class="breadcrumb">
        <?php foreach ($breadcrumbs as $breadcrumb) { ?>
        <li><a href="<?php echo "Add Village"; ?>"><?php echo "Add Village"; ?></a></li>
        <?php } ?>
      </ul>
    </div>
  </div>
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-exchange"></i>Add Village</h3>
      </div>
      <div class="panel-body">
        ...
        <ul id="geo" class="nav nav-tabs nav-justified">
            <li class="active"><a href="#tab-nation" data-toggle="tab">1. Tehsil</a></li>
            <li class=""><a href="#tab-region" data-toggle="tab">2. Block</a></li>
            <li class=""><a href="#tab-village" data-toggle="tab">3. village</a></li>
