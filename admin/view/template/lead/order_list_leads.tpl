              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'o.date_added') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><!--<?php if ($sort == 'o.date_potential') { ?>
                    <a href="<?php echo $sort_date_potential; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_date_potential; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_date_potential; ?>"><?php echo $column_date_potential; ?></a>
                    <?php } ?>-->Date Potential
</td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=lead/orderleads&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=lead/orderleads/download_excel&token=<?php echo $token; ?>';
