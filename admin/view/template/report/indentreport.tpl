          ...
          <table class="table table-bordered">
            <thead>
              <tr style="background: #515151;color: #ffffff;">
                ...
                <td class="text-center">MO NAME</td>
                <td class="text-center">AM NAME</td>
		...
		<td class="text-center">INDENT DATE</td>		
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"><?php echo $order['Mo']; ?></td>
                <td class="text-center" ><?php echo $order['am']; ?></td>
                <td class="text-center" width="15%"><?php echo $order['wholesaler_name']; ?></td>
                <td class="text-center"><?php echo $order['indateorder']; ?></td>
                <td class="text-center"><?php echo $order['indnumber']; ?></td>
                <td class="text-center" onclick="orderdtl(<?php echo $order['indnumber']; ?>,'<?php echo $order['wholesaler_name']; ?>','<?php echo $order['indateorder']; ?>');"><span class="btn-primary btn-sm" style=" width: 90%;"><?php echo $order['sum_of_qnty']; ?></span></td>
...
function orderdtl(datno,datnm,datdt)
{    
    ...
    //alert(datdt);
        ...
        data: 'orddata='+datno+'&wsname='+datnm+'&orddate='+datdt,
