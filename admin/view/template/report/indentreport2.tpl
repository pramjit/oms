          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <td class="text-center">Wholeseller Name</td>                                   
		<td class="text-center">Indent Date</td>		
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center" onclick="orderdtl(<?php echo $order['indnumber']; ?>);"><?php echo $order['sum_of_qnty']; ?></td>
                <td class="text-center"><?php if($order['order_status']=='1'){ echo "Not Approved";  } else { echo "Approved"; } ?></td>
              </td>
