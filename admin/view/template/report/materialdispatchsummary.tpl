...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <h1>Material Dispatch Summary Report</h1>
      <ul class="breadcrumb">
        <?php foreach ($breadcrumbs as $breadcrumb) { ?>
        <li><a href="<?php echo $breadcrumb['href']; ?>">Material Dispatch Summary Report</a></li>
        <?php } ?>
      </ul>
    </div>
  </div>
  <div class="container-fluid">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-bar-chart"></i>Material Dispatch Summary Report</h3>
          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <td class="text-center" width="10%">ORDER DATE</td>
                <td class="text-center">PARTY NAME</td>
                <td class="text-center">ORDER NO</td>                                   
		<td class="text-center">PRODUCT NAME</td>		
                <td class="text-center">ORDER QTY.</td> 
                <td class="text-center">DISPATCH QTY.</td> 
                <td class="text-center">DISPATCH DATE</td>
                <td class="text-center">PENDING QTY</td> 
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"><?php echo $order['SO_DATE']; ?></td>
                <td class="text-center"><?php echo $order['STO_NAME']; ?></td>
                <td class="text-center"><?php echo $order['SO_NO']; ?></td>
                <td class="text-center"><?php echo $order['PRO_NAME']; ?></td>
                <td class="text-center"><?php echo $order['SO_QTY']; ?></td>
                <td class="text-center"><?php echo $order['DISP_QTY']; ?></td>
                <td class="text-center"><?php echo $order['DISP_DATE']; ?></td>
                <td class="text-center"><?php echo $order['SO_QTY']-$order['DISP_QTY']; ?></td>
...
$('#button-filter').on('click', function() {
        ...
        url = 'index.php?route=report/materialdispatchsummary&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() { 
	url = 'index.php?route=report/materialdispatchsummary/download_excel&token=<?php echo $token; ?>';
