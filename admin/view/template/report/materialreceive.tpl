...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <h1>Material Receive  Report</h1>
      <ul class="breadcrumb">
        <?php foreach ($breadcrumbs as $breadcrumb) { ?>
        <li><a href="<?php echo $breadcrumb['href']; ?>">Material Receive  Report</a></li>
        <?php } ?>
      </ul>
    </div>
  </div>
  <div class="container-fluid">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-bar-chart"></i>Material Receive  Report</h3>
          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <td class="text-left">RCV. DATE</td>
                <td class="text-left">RCV. FROM</td>
                <td class="text-left">IND. NO</td>                                   
		<td class="text-left">SO NO.</td>		
                <td class="text-left">IND QTY.</td>              
                <td class="text-left">RCV QTY.</td>
