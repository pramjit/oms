  ...
  <div class="page-header">
    <div class="container-fluid">
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="<?php echo $breadcrumb['href']; ?>">Monthly Summary Report</a></li>
        <?php } ?>
      </ul>
    </div>
  </div>
  <div class="container-fluid">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-bar-chart"></i> Monthly Summary Report</h3>
...
$('#button-filter').on('click', function() {
        ...
        url = 'index.php?route=report/monthlysummaryreport&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() { 
	url = 'index.php?route=report/monthlysummaryreport/download_excel&token=<?php echo $token; ?>';
        var gmo_id = $('#mo_id').val();
        var gmo_nm = $("#mo_id option[value='"+gmo_id+"']").text();
