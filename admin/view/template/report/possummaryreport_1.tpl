...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <h1>Retailer Summary Report</h1>
      <ul class="breadcrumb">
        <?php foreach ($breadcrumbs as $breadcrumb) { ?>
        <li><a href="<?php echo $breadcrumb['href']; ?>">Retailer Summary Report</a></li>
        <?php } ?>
      </ul>
    </div>
  </div>
  <div class="container-fluid">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-bar-chart"></i>Retailer Summary Report</h3>
      ...
      <div class="panel-body">
		...
		<td class="text-right">Block</td>		
                ...
                <td class="text-right">Tin/Gst No</td>
                <td class="text-right">Pan No</td>
                <td class="text-right" >Addhar no</td>
                <td class="text-right">Frc No</td>
                <td class="text-right">FRC Valid Upto</td>
                <td class="text-right">Seed License No</td>
                <td class="text-right">Seed License Upto</td>
                <td class="text-right" >Mfms ID</td>
                <td class="text-right">Created On</td>
                <td class="text-right">MO Name</td>
                <td class="text-right">No of Visit</td>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-right"><?php echo $order['CONTACT_PERSON']; ?></td>
                <td class="text-right"><?php echo $order['MOBILE']; ?></td>
		...
		<td class="text-right"><?php echo $order['PINCODE']; ?></td>
                <td class="text-right"><?php echo $order['TIN_GST_NO']; ?></td>
                <td class="text-right"><?php echo $order['PAN_NO']; ?></td>
                <td class="text-right"><?php echo $order['ADDHAR_NO']; ?></td>
                <td class="text-right"><?php echo $order['FRC_NO']; ?></td>
                <td class="text-right"><?php echo $order['FRC_VALID_UPTO']; ?></td>                
		<td class="text-right"><?php echo $order['SEED_LICENCE']; ?></td>
                <td class="text-right"><?php echo $order['SEED_LICENCE_UPTO']; ?></td>
                <td class="text-right"><?php echo $order['MFMS_ID']; ?></td>
                <td class="text-right"><?php echo $order['CR_DATE']; ?></td>
                <td class="text-right"><?php echo $order['MO_NAME']; ?></td>
                <td class="text-right"><?php echo $order['noofvisit']; ?></td>
             </tr>
...
$('#button-filter').on('click', function() {
        ...
        url = 'index.php?route=report/possummaryreport&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() { 
	url = 'index.php?route=report/possummaryreport/download_excel&token=<?php echo $token; ?>';
        var gmo_id = $('#mo_id').val();
        var gmo_id = $('#mo_id').val();
        var gmo_nm = $("#mo_id option[value='"+gmo_id+"']").text();
