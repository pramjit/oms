          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <td class="text-right">No of Orders</td>
                <td class="text-right">Total Sales</td>
                <td class="text-right">Total Tax</td>
                <td class="text-right">Total (Sales + Tax)</td>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-right"><?php echo $order['No_of_orders']; ?></td>
                <td class="text-right"><?php echo number_format((float)$order['Total_sales'], 2, '.', ''); ?></td>
                <td class="text-right"><?php echo number_format((float)$order['Total_tax'], 2, '.', ''); ?></td>
                <td class="text-right"><?php echo number_format((float)($order['Total_sales']+$order['Total_tax']), 2, '.', ''); ?></td>
                
              </tr>
              <?php 
              $total_sales=$total_sales+$order['Total_sales'];
              $Total_tax=$Total_tax+$order['Total_tax'];
              $Total=$Total+$order['Total_sales']+$order['Total_tax'];
              } ?>
              <?php } else { ?>
              <tr>
        ...
        <div class="row">
          ...
          <div class="col-sm-6 text-right">
              <span style="font-weight: bold;">
                  Total Sales : <?php echo number_format((float)$total_sales, 2, '.', ''); ?> | 
