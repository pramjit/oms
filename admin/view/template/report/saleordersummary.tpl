...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <h1>Sale Order Summary Report</h1>
      <ul class="breadcrumb">
        <?php foreach ($breadcrumbs as $breadcrumb) { ?>
        <li><a href="<?php echo $breadcrumb['href']; ?>">Sale Order Summary Report</a></li>
        <?php } ?>
      </ul>
    </div>
  </div>
  <div class="container-fluid">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-bar-chart"></i>Sale Order Summary Report</h3>
          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <td class="text-center">WHOLESALER</td>
                <td class="text-center">PROD. CODE</td>
                <td class="text-center" width="15%">PROD. NAME</td>  
                <td class="text-center">SO NO.</td>
		<td class="text-center">SO QTY.</td> 
                <td class="text-center">DISP. QTY.</td>
                <td class="text-center">IND. ID(S)</td>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"><?php echo $order['PRO_CODE']; ?></td>
...
$('#button-filter').on('click', function() {
        ...
        url = 'index.php?route=report/saleordersummary&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() { 
	url = 'index.php?route=report/saleordersummary/download_excel&token=<?php echo $token; ?>';
        var gws_id = $('#ws_id').val();
        var gws_nm = $("#ws_id option[value='"+gws_id+"']").text();
       if(gws_id!=null)
       {
