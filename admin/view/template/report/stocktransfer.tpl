  ...
  <div class="page-header">
    <div class="container-fluid">
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="<?php echo $breadcrumb['href']; ?>">Stock Transfer Report</a></li>
        <?php } ?>
      </ul>
    </div>
  </div>
  <div class="container-fluid">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-bar-chart"></i> Stock Transfer Report</h3>
    ...
    <div class="panel-body">
		...
		<td class="text-center">Prod. Quantity</td>		
                <td class="text-center">Product Price (Rs.)</td>              
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                ...
                <td class="text-left"><?php echo $order['SO_DATE']; ?></td>
                <td class="text-left"><?php echo $order['SO_PARTY_NAME']; ?></td>
                <td class="text-left"><?php echo $order['OS_PRO_NAME']; ?></td>
                <td class="text-left"><?php echo $order['OS_PRO_QTY']; ?></td>
                <td class="text-left"><?php echo ($order['OS_PRO_AMT'] / $order['OS_PRO_QTY']); ?></td>
...
$('#button-filter').on('click', function() {
        ...
        url = 'index.php?route=report/stocktransfer&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() { 
	url = 'index.php?route=report/stocktransfer/download_excel&token=<?php echo $token; ?>';
