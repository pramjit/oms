...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <h1>TA Summary Report</h1>
      <ul class="breadcrumb">
        <?php foreach ($breadcrumbs as $breadcrumb) { ?>
        <li><a href="<?php echo $breadcrumb['href']; ?>">TA Summary Report</a></li>
        <?php } ?>
      </ul>
    </div>
  </div>
  <div class="container-fluid">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-bar-chart"></i> TA Summary Report</h3>
      ...
      <div class="panel-body">
		...
		<th class="text-center">Place From</th>
	<th class="text-center">Place From - I</th>		
                <th class="text-center">Place From - II</th>
                <th class="text-center">Place From - III</th>
                <th class="text-center">Place From - IV</th>
                <th class="text-center">Place From - V</th>
                <th class="text-center">Tot.Km</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-left" style="width: 8%;"><?php echo date("d-m-Y", strtotime($order['TA_DATE'])); ?></td>
                <td class="text-left"><?php echo $order['firstname']; ?></td>
                <td class="text-left"><?php echo $order['telephone']; ?></td>
                <td class="text-left"><?php echo $order['PLACE_FROM']; ?></td>                
		<td class="text-left"><?php echo $order['PLACE_TO']; ?></td>
                <td class="text-left"><?php echo $order['PLACE_TO1']; ?></td>
                <td class="text-left"><?php echo $order['PLACE_TO2']; ?></td>
                <td class="text-left"><?php echo $order['PLACE_TO3']; ?></td>
                <td class="text-left"><?php echo $order['PLACE_TO4']; ?></td>
                <td class="text-left"><?php echo $order['TOTAL']; ?></td>
                <td class="text-left" onclick="upload(<?php echo "'".$order['SID']."'"; ?>);"><button style="font-size:14px;color:#1a1a1a">Docs &nbsp;<i class="fa fa-clipboard"></i></button></td>                
