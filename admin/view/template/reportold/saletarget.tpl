      ...
      <div class="panel-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <textarea rows="4" cols="50" class="form-control" type="text" name="tdesp">
                </textarea>
              </div>
            </div><br/>
             <div class="col-sm-2">
        ...
        <div class="table-responsive">
          <table class="table" id="table_add_product">
            ...
            <tbody>
                <tr id="PNO0">
                    <td class="text-left"><div id="prod0"><input type="text" placeholder="Product Name" name="prod_name[]" id="prod_name0" value="" class="form-control m-b" ></div></td>
	...
	function add_new_row(rn){ 
        ...
        var add_new = '<tr id="PNO'+PNO+'">';        	
			add_new +=  '<td><div id="prod'+PNO+'">';
   			add_new +=  '<input type="text" placeholder="Product Name" name="prod_name[]" id="prod_name'+PNO+'" value="" class="form-control m-b" required="required" >';
   			add_new +=  '</div></td>';
