  ...
  <div class="container-fluid">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
		...
		<td class="text-right">Place From</td>		
                <td class="text-right">Place From 1</td>
                <td class="text-right">Place From 2</td>
                <td class="text-right">Place From 3</td>
                <td class="text-right" >Place From 4</td>
                <td class="text-right">Total Km</td>
		...
		<td class="text-right"><?php echo $order['PLACE_TO1']; ?></td>
                ...
                <td class="text-right"><?php echo $order['PLACE_TO3']; ?></td>
                <td class="text-right"><?php echo $order['PLACE_TO4']; ?></td>
                <td class="text-right"><?php echo $order['TOTAL']; ?></td>
                <td class="text-right" onclick="upload(<?php echo "'".$order['SID']."'"; ?>);"><button style="font-size:14px">Docs &nbsp;<i class="fa fa-cloud-upload"></i></button></td>                
