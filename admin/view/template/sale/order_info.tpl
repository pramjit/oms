    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <ul class="nav nav-tabs">
          ...
          <li><a href="#tab-history" <?php if($group=="11") { echo "style='display:none;'"; } ?> data-toggle="tab"><?php echo $tab_history; ?></a></li>
