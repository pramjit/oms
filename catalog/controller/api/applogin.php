...
class ControllerApiApplogin extends Controller {
    


public  function gcm(){
        $this->load->model('account/appcustomer');
...
$log->write("end data");
            ...
            $customer_info = $this->model_account_appcustomer->getCustomerByUserId($this->request->post['emp_id']);
     ...
     $json=new resop();
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') ) {
			...
			$this->model_account_appcustomer->editPassword($this->request->post['emp_id'], $password);			
			// Add to activity log
			$customer_info = $this->model_account_appcustomer->getCustomer($this->request->post['emp_id']);
			if ($customer_info) {
				$this->load->model('account/activity');
     ...
     $json=new resop();
        ...
        //
             ...
             $this->load->model('account/appcustomer');
             $mobile_info = $this->model_account_appcustomer->checkmobile($this->request->post['emp_id']);
