...
class ControllerApiJeepcampaignupdatedisel extends Controller {
	public function index() {
            $log=new Log("Jeepcampaignupdatedealer.log");
		...
		$json = array();
               ...
               //$this->request->post["DIESEL_RS"]='b7aefdb84de75f2c2fe57124859c2cad';
...
foreach ($keys as $key) {
        ...
        //log to table
				...
				$this->model_account_activity->addActivity('jeepcampaignupdatedisel', $activity_data);
...
if (isset($this->request->post["SID"]) !="0"){
		...
		$api_info = $this->model_JeepCampaign_jeepcampaign->jeepcampaignupdatedisel($this->request->post);
        $log->write($api_info);
