            ...
            if (isset($this->request->post["username"])  && $this->request->post["username"]!="0"){
                ...
                if ($api_info>0) {	
                    ...
                    $MoName=$MsgDtls['MO_NAME'];
                            ...
                            $numbers = array($AM_MOB, $InMob_I, $InMob_II);
                            //$numbers = array($InMob_III,$InMob_IV);
                            
                        
                            //$textmsg='Payment of M/s DealerName of Rs. TotalRs /- on SubDate submitted by MoName .';
                            $textmsg='Payment of M/s PartyName , DistName of Rs. PayAmount /- on PayDate submitted by MoName .';
                            $textmsg=str_replace('PartyName',$DealerName,$textmsg);
                            $textmsg=str_replace('DistName',$DealerDist,$textmsg);
                            $textmsg=str_replace('PayAmount',$TotalRs,$textmsg);
                            $textmsg=str_replace('PayDate',$SubDate,$textmsg);
