...
WHEN oc_po_order.order_status = 4 THEN 'KICK'
ELSE 'NA'
...
WHERE oc_po_order.store_id = '".$sto."'
GROUP BY oc_po_order.id, oc_po_order.order_date, oc_sap_ref.sap_ref, oc_po_order.order_status";
         ms_type.add(new Myspinner("Type","0"));
ms_type.add(new Myspinner("Pending for Approve","1"));
ms_type.add(new Myspinner("Pending for Order","2"));
         * ms_type.add(new Myspinner("Partial Order","6"));
ms_type.add(new Myspinner("Pending for Dispatch","3"));
ms_type.add(new Myspinner("Partial Dispatched","4"));
ms_type.add(new Myspinner("Dispatched","9"));
ms_type.add(new Myspinner("Rejected","7"));
ms_type.add(new Myspinner("Hold","5"));
ms_type.add(new Myspinner("Receive","8"));
ms_type.add(new Myspinner("Partial Received","11"));
         */
...
WHEN oc_po_order.order_status = 1 THEN 'PENDING'
WHEN oc_po_order.order_status = 2 THEN 'APPROVED'
WHEN oc_po_order.order_status = 3 THEN 'PENDING FOR DISPATCH'
WHEN oc_po_order.order_status = 4 THEN 'PARTIAL DISPATCHED'
WHEN oc_po_order.order_status = 5 THEN 'HOLD'
WHEN oc_po_order.order_status = 6 THEN 'PARTIAL ORDERED'
WHEN oc_po_order.order_status = 7 THEN 'REJECTED'
WHEN oc_po_order.order_status = 8 THEN 'RECEIVED'
WHEN oc_po_order.order_status = 9 THEN 'DISPATCHED'
WHEN oc_po_order.order_status = 10 THEN 'NA'
WHEN oc_po_order.order_status = 11 THEN 'PARTIAL RECEIVED'
ELSE 'NA'
END) AS 'IND_STATUS'from oc_po_order
