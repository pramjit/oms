...
class Modelgeoaddgeovillage extends Model {
    ...
    {
          $query = $this->db->query("SELECT NAME  FROM " . DB_PREFIX . "mst_geo_lower WHERE NAME='". $data['tehsil_name'] ."' and DISTRICT_ID='". $data['select_district_territory'] ."' and STATE_ID='". $data['select_tehsil_state'] ."' and TYPE='1'");
          $nationnamr=$query->row["NAME"]; 
          if(empty($nationnamr)) {
        $sql="INSERT INTO " . DB_PREFIX . "mst_geo_lower SET NAME = '" . $data['tehsil_name'] . "',DISTRICT_ID='". $data['select_district_territory'] ."', `TYPE` = '1',`STATE_ID`='". $data['select_tehsil_state'] ."', `ACT` = '1' ";
    ...
    {
          $query = $this->db->query("SELECT NAME  FROM " . DB_PREFIX . "mst_geo_lower WHERE NAME='". $data['Block_name'] ."' and DISTRICT_ID='". $data['select_district_territory_block'] ."' and STATE_ID='". $data['select_block_state'] ."' and TYPE='2'");
          $nationnamr=$query->row["NAME"]; 
          if(empty($nationnamr)) {
        $sql="INSERT INTO " . DB_PREFIX . "mst_geo_lower SET NAME = '" . $data['Block_name'] . "',DISTRICT_ID='". $data['select_district_territory_block'] ."', `TYPE` = '2',`STATE_ID`='". $data['select_block_state'] ."', `ACT` = '1' ";
    ...
    {
          $query = $this->db->query("SELECT NAME  FROM " . DB_PREFIX . "mst_geo_lower WHERE NAME='". $data['village_name'] ."' and DISTRICT_ID='". $data['select_district_territory_village'] ."' and STATE_ID='". $data['select_village_state'] ."' and TEHSIL_ID='". $data['select_tehsil'] ."' and BLOCK_ID='". $data['select_block'] ."' and TYPE='3'");
          $nationnamr=$query->row["NAME"]; 
          if(empty($nationnamr)) {
        $sql="INSERT INTO " . DB_PREFIX . "mst_geo_lower SET NAME = '" . $data['village_name'] . "',DISTRICT_ID='". $data['select_district_territory_village'] ."', `TYPE` = '3',`STATE_ID`='". $data['select_village_state'] ."',`BLOCK_ID`='". $data['select_block'] ."',TEHSIL_ID='". $data['select_tehsil'] ."' , `ACT` = '1' ";
    ...
    public function get_District_State(){
          $query = $this->db->query("SELECT NAME as 'name',SID as 'id'  FROM " . DB_PREFIX . "mst_geo_upper WHERE STATE_ID='".$data['select_district_state']."' and  TYPE='4'  and ACT ='1' order by name asc");
    ...
    public function getterritorystate($data){
        ...
        $query = $this->db->query("SELECT NAME,SID FROM " . DB_PREFIX . "mst_geo_upper where  TYPE=4 and ACT ='1'");
        return $query->rows;
    ...
    public function getdistrict($data){
        ...
        $query = $this->db->query("SELECT NAME,SID FROM " . DB_PREFIX . "mst_geo_upper where STATE_ID='".$data['stateid']."' and TYPE=4");
        return $query->rows;

    }
      //district
    public function getdistrictteri($data){
        $query1="SELECT NAME,SID FROM " . DB_PREFIX . "mst_geo_upper where AREA_ID='".$data['territory_id']."' and TYPE=4";
     ...
     public function gettehsil($data){
        ...
        $query = $this->db->query("SELECT SID,NAME  FROM " . DB_PREFIX . "mst_geo_lower WHERE DISTRICT_ID='".$data["districtid"]."' and  TYPE='1' order by NAME asc");

        return $query->rows;   
    }
      public function getblock($data){
       
        $query = $this->db->query("SELECT SID,NAME  FROM " . DB_PREFIX . "mst_geo_lower WHERE DISTRICT_ID='".$data["districtid"]."' and TYPE='2' order by NAME asc");
