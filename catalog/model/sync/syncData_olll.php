...
$fid= date(dmYmis);
    ...
    $log=new Log("sync-model-".date('Y-m-d').".log");
...
if(count($data2)>0)
{
	$log->write('in foreach loop for oc_payment_ref');
...
{
$log->write('there is no data available in oc_payment_ref');	
}*/
