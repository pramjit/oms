    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <ul id="geo" class="nav nav-tabs nav-justified">
            <li class="active"><a href="#tab-nation" data-toggle="tab">1. <?php echo $tab_nation; ?></a></li>
            <li class=""><a href="#tab-zone" data-toggle="tab">2. <?php echo $tab_zone; ?></a></li>
            <li class=""><a href="#tab-region" data-toggle="tab">3. <?php echo $tab_region; ?></a></li>
